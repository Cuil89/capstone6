...
VAGUE_HEALTH_TERMS = {
    "wabah", "pandemi", "pandemic", "epidemic", "outbreak", 
    "kasus", "case", "cases", "gejala", "penularan", "demam", "batuk"
}
BLOCKED_NEWS_KEYWORDS = [
    ...
    "crypto", "korupsi", "koruptor", "kpk", "politik", "pemilu",
    "pilkada", "partai", "artis", "seleb", "judi", "pinjol", "saham",
    "kriminal", "polisi", "narkoba", "geng motor", "pembunuhan",
]
...
def _build_news_item(
    *,
    ...
    # Smart filtering: if the only hits are vague terms (like "wabah" or "kasus") 
    # without any specific medical context (like "virus" or "penyakit" or a specific disease), drop it.
    if hits and all(h in VAGUE_HEALTH_TERMS for h in hits):
        return None
